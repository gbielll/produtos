...
export default function Menu() {
  ...
  function seletorDeComponente() {
    if (visible === 1) {
      return <ProductRegister text={"cadastro de produtos"}/>; //use o Return quando for chamar 
    } else if (visible === 2) {
      return <ProductList text={"listagem de produtos"} />;    //use o Return quando for chamar 
    } else if (visible === 3) {
      return <CategoryRegister text={"cadastro de categorias"} />;  //use o Return quando for chamar 
    } else {
      return <CategoryList text={"lisgarem de categorias"} />;  //use o Return quando for chamar 
    }
  }
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Main open={open}> {/*CONTEUDO*/}
        <DrawerHeader />
        <Container>  {/*tudo que tiver dentre desse container fica respansível*/}
          {seletorDeComponente()}
        </Container>
      </Main>
    </Box>
